...
var map = {
	...
	"./sos/list/list.module": [
		"./src/app/sos/list/list.module.ts",
		"sos-list-list-module"
	],
	"./sos/map/map.module": [
		"./src/app/sos/map/map.module.ts",
		"sos-map-map-module"
	],
	"./static/harashment/harashment.module": [
		"./src/app/static/harashment/harashment.module.ts",
		"static-harashment-harashment-module"
	],
	"./static/helpline/helpline.module": [
		"./src/app/static/helpline/helpline.module.ts",
		"static-helpline-helpline-module"
	],
	"./static/info/info.module": [
		"./src/app/static/info/info.module.ts",
		"static-info-info-module"
	],
	"./static/support/support.module": [
...
/* harmony import */ var _guards_noauth_guard__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./guards/noauth.guard */ "./src/app/guards/noauth.guard.ts");
...
var routes = [
    ...
    },
    {
        ...
        canActivate: [_guards_noauth_guard__WEBPACK_IMPORTED_MODULE_4__["NoauthGuard"]]
    },
    {
        path: 'register',
...
module.exports = "<ion-app>\n  <!--For Authenticated Routes only-->\n  <ion-split-pane contentId=\"menu-content\" *ngIf=\"username\">\n    <!--  our side menu  -->\n    <ion-menu contentId=\"menu-content\" class=\"menu\">\n      <ion-header>\n        <ion-toolbar color=\"primary\">\n          <ion-title>{{ username }}</ion-title>\n        </ion-toolbar>\n      </ion-header>\n      <ion-content>\n        <ion-list>\n          <ion-item href=\"/profile\">\n            Profile\n          </ion-item>\n          <ion-item href=\"/list\">\n            SOS List\n          </ion-item>\n          <ion-item href=\"/info\">\n            Voilence\n          </ion-item>\n          <ion-item href=\"/harashment\">\n            Rape Victims\n          </ion-item>\n          <ion-item href=\"/support\">\n            Support Us\n          </ion-item>\n          <ion-item href=\"/helpline\">\n            Helpline\n          </ion-item>\n          <ion-item (click)=\"logoutUser()\">\n            Logout\n          </ion-item>\n        </ion-list>\n      </ion-content>\n    </ion-menu>\n    <!-- the main content -->\n    <ion-router-outlet (activate)=\"onActivate($event)\" (deactivate)=\"onActivate($event)\" id=\"menu-content\">\n    </ion-router-outlet>\n  </ion-split-pane>\n  <!--For Authenticated Routes only-->\n  <!--For Unauthenticated Route only-->\n  <ion-router-outlet *ngIf=\"!username\" (activate)=\"onActivate($event)\" (deactivate)=\"onActivate($event)\">\n  </ion-router-outlet>\n  <!--For Unauthenticated Route only-->\n</ion-app>"
...
var AppComponent = /** @class */ (function () {
    ...
    AppComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        ...
        tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:paramtypes", [_ionic_angular__WEBPACK_IMPORTED_MODULE_3__["Platform"],
            ...
            _services_network_service__WEBPACK_IMPORTED_MODULE_2__["NetworkProvider"],
    ...
    AppModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
            ...
            providers: [
                ...
                _services_network_service__WEBPACK_IMPORTED_MODULE_12__["NetworkProvider"],
...
module.exports = "\n/*# sourceMappingURL=data:application/json;base64,eyJ2ZXJzaW9uIjozLCJzb3VyY2VzIjpbXSwibmFtZXMiOltdLCJtYXBwaW5ncyI6IiIsImZpbGUiOiJzcmMvYXBwL2FwcC5zdHlsZS5zY3NzIn0= */"
...
var AuthGuard = /** @class */ (function () {
    function AuthGuard(util, navCtrl, router) {
        this.util = util;
...
var NoauthGuard = /** @class */ (function () {
    function NoauthGuard(util, navCtrl, router) {
        this.util = util;
        this.navCtrl = navCtrl;
        this.router = router;
    }
...
var NetworkProvider = /** @class */ (function () {
    function NetworkProvider(toast, http, navCtrl, loadingCtrl) {
        this.toast = toast;
        this.http = http;
        this.navCtrl = navCtrl;
    ...
    /*********************** Show Toast */
    NetworkProvider.prototype.toastPresent = function (message, cssProp) {
    ...
    /*********************** Show Loading */
    /*********************** TOKEN FUNCTION */
    NetworkProvider.prototype.saveToken = function (token) {
        localStorage.setItem('jwt_token', token);
    };
    NetworkProvider.prototype.destroyToken = function () {
        localStorage.removeItem('jwt_token');
    };
    NetworkProvider.prototype.getToken = function () {
        return localStorage.getItem('jwt_token');
    };
    NetworkProvider.prototype.checkValidity = function () {
        var token = localStorage.getItem('jwt_token');
        // decode token
        if (token != undefined) {
            var decoded = jwt_decode__WEBPACK_IMPORTED_MODULE_5__((token).split(' ')[1]);
    ...
    NetworkProvider.prototype.authUser = function () {
        var token = localStorage.getItem('jwt_token');
        if (token != undefined) {
            var decoded = jwt_decode__WEBPACK_IMPORTED_MODULE_5__((token).split(' ')[1]);
            return decoded._id;
    ...
    // Get the username
    NetworkProvider.prototype.getusername = function () {
        var token = localStorage.getItem('jwt_token');
        if (token != undefined) {
            var decoded = jwt_decode__WEBPACK_IMPORTED_MODULE_5__((token).split(' ')[1]);
            return decoded.name;
    ...
    // Get the user._id
    NetworkProvider.prototype.getuserId = function () {
        var token = localStorage.getItem('jwt_token');
        if (token != undefined) {
            var decoded = jwt_decode__WEBPACK_IMPORTED_MODULE_5__((token).split(' ')[1]);
            return decoded._id;
    ...
    NetworkProvider.prototype.returnUserType = function () {
        var token = localStorage.getItem('jwt_token');
        var decoded = jwt_decode__WEBPACK_IMPORTED_MODULE_5__((token).split(' ')[1]);
        return decoded.type;
    };
    ...
    NetworkProvider.prototype.postData = function (url, data) {
        var _this = this;
    ...
    NetworkProvider.prototype.getAuthData = function (url, params) {
        // Preparing headers
        var httpOptions = {};
        ...
        if (params) {
            var sParams = new _angular_common_http__WEBPACK_IMPORTED_MODULE_3__["HttpParams"]();
    ...
    NetworkProvider.prototype.postAuthData = function (url, data, params) {
    ...
    NetworkProvider.prototype.deleteAuthData = function (url, params) {
        var token = this.getToken();
        var headers = new _angular_common_http__WEBPACK_IMPORTED_MODULE_3__["HttpHeaders"]({
            "Content-Type": "application/json",
            Authorization: token
    ...
    /*********************** HTTP REQUESTS*/
    NetworkProvider.prototype.handleError = function (error) {
        var errorMessage = "";
...
module.exports = __webpack_require__(/*! /Users/narendramaurya/web_tutorials/Deepa/frontend/src/main.ts */"./src/main.ts");
