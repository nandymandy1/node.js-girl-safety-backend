...
module.exports = "<ion-header>\n  <ion-toolbar color=\"primary\">\n    <ion-title>\n      Login\n    </ion-title>\n  </ion-toolbar>\n</ion-header>\n\n<ion-content>\n  <div class=\"ion-padding\">\n    <ion-card>\n      <ion-card-content>\n        <ion-item>\n          <ion-label position=\"floating\">Username</ion-label>\n          <ion-input name=\"username\" [(ngModel)]=\"username\"></ion-input>\n        </ion-item>\n        <ion-item>\n          <ion-label position=\"floating\">Password</ion-label>\n          <ion-input type=\"password\" name=\"password\" [(ngModel)]=\"password\"></ion-input>\n        </ion-item>\n        <br>\n        <ion-button expand=\"block\" fill=\"solid\" (click)=\"authenticate()\">Login</ion-button>\n        <ion-button expand=\"block\" fill=\"solid\" (click)=\"goToRegister()\">Need an Account?</ion-button>\n        <ion-button expand=\"block\" fill=\"outline\" (click)=\"intro()\">Why to use this App?</ion-button>\n      </ion-card-content>\n    </ion-card>\n  </div>\n</ion-content>"
...
var HomePage = /** @class */ (function () {
    function HomePage(util, navCtrl, router) {
        this.util = util;
    ...
    HomePage.prototype.authenticate = function () {
        ...
        if (this.username != '' && this.password != '') {
            ...
            this.util.postData('users/login', data).subscribe(function (res) {
                if (res.success) {
                    _this.username = "";
                    _this.password = "";
                    _this.navCtrl.navigateForward('/feed');
                }
                else {
                    console.log(res);
                    _this.util.toastPresent(res.message, 'danger');
                }
            });
        }
        else {
